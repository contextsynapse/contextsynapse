"""
LangGraph adapter — thin wrapper over Universal Tool Layer.

Usage:
    from contextsynapse.adapters.langgraph.tools import create_langgraph_tools
    tools = create_langgraph_tools(namespace="my-project")
"""
...
def create_langgraph_tools(
    ...
    """Create LangGraph-compatible tools from the Universal Tool Registry."""
    try:
    ...
    ctx = ToolContext(conn=conn, agent_id="langgraph", agent_name="langgraph")

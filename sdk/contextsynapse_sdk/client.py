"""ContextSynapse SDK — main client."""
...
from .exceptions import AuthError, NotFoundError, ContextSynapseError, AIContextDBError
...
class _AgentsAPI:
    ...
    def __init__(self, client: "ContextSynapseClient"):
        self._client = client
...
class ContextSynapseClient:
    """ContextSynapse Context-as-a-Service client.

    Usage:
        ctx = ContextSynapseClient(base_url="http://localhost:8000", api_key="agent_id:secret")
    ...
    def _handle_response(self, resp: httpx.Response) -> dict:
        ...
        if resp.status_code >= 400:
            try:
                ...
                detail = resp.text
            raise ContextSynapseError(f"API error {resp.status_code}: {detail}", resp.status_code)
        try:
            return resp.json()
        except Exception:
    ...
    def __repr__(self) -> str:
        return f"ContextSynapseClient(base_url={self.base_url!r})"


# Backward compatibility alias
AIContextDB = ContextSynapseClient

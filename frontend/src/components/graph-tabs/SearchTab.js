...
export default function SearchTab({ graphName }) {
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {r.node_type && (
                          <span className="px-1.5 py-0.5 rounded text-xs" style={{ background: 'var(--neo-bg)', color: 'var(--neo-blue)' }}>
                            {r.node_type}
                          </span>
                        )}
                      </div>
                      {r.snippet && (
                        <p className="text-xs mt-1" style={{ color: 'var(--neo-text-muted)' }}>{r.snippet}</p>
                      )}
                    ...
                    {r.score !== undefined && (
                      <span className="text-xs font-mono shrink-0 ml-3 px-2 py-1 rounded" style={{ background: 'var(--neo-bg)', color: 'var(--neo-green)' }}>
